...
class RealEstateProjectsScreen extends StatefulWidget {
  ...
  const RealEstateProjectsScreen({
    Key? key,
  ...
  @override
  _RealEstateProjectsScreenState createState() => _RealEstateProjectsScreenState();
}

class _RealEstateProjectsScreenState extends State<RealEstateProjectsScreen> {
  ...
  void _showReport(Map<String, dynamic> project) {
    if (widget.subcategory == 'Аренда') {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => RentReportScreen(
            projectData: project,
            onEditProject: () {
