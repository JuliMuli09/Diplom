...
class BusinessProjectsScreen extends StatefulWidget {
  final String subcategory;
  final Color projectColor;
  final IconData projectIcon;

  const BusinessProjectsScreen({
    Key? key,
  ...
  @override
  _BusinessProjectsScreenState createState() => _BusinessProjectsScreenState();
}

class _BusinessProjectsScreenState extends State<BusinessProjectsScreen> {
  ...
  void _navigateToCalculator({Map<String, dynamic>? projectToEdit}) async {
    final result = await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => BusinessCalculatorTab(
              ...
              child: ListTile(
                ...
                subtitle: Column(
                  ...
                  children: [
                    ...
                    if (project['initialInvestment'] != null)
                      Text(
                        'Инвестиции: ${project['initialInvestment']} руб.',
                        style: const TextStyle(
                          fontSize: 12,
                          color: Colors.blue,
                        ),
